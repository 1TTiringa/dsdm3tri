...
import 'package:dsdm0410/model/personagem.dart';
...
Future<List<Personagem>> pageData() async {
  ...
  if(response.statusCode == 200) {
    ...
    dados_result.forEach((personagem) {
      ...
      Personagem p = Personagem(id: personagem['id'], name: personagem['name'], status: personagem['status'], species: personagem['species'], type: personagem['type'], gender: personagem['gender'], image: personagem['image'], episode: [], url: personagem['url'], created: personagem['created']);
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if(!snapshot.hasData){
            ...
            itemCount: listaPersonagens.length, itemBuilder: (context, index){
